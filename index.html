...
<body>
    ...
    <header>
        ...
        <a id="logo" href="index.html">
            <img src="img/PhaniKumar.jpg" alt="Logo">
    ...
    <main>
        ...
        <div class="site-section-inside">
            ...
            <div class="testimonial-box">
                ...
                <div class="testimonial-author">
                    <img src="C:\Users\KIRAN\Desktop\download.jpg." alt="Holly Lloyd">
                    <h5>Holly Lloyd</h5>
    ...
    <!-- the footer -->
    <footer>
        <img src="img/PhaniKumar.jpg" alt="Footer Logo">
        <span>My Website<br>Copyright &copy; 2019-2020 </span>
    </footer>
